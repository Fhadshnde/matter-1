  ...
  return (
    <>
      ...
      {openModal && (
        ...
        >
          <div
            className="bg-[#1A1A1A] rounded-2xl h-[90%] w-full max-w-3xl border border-white/5 shadow-2xl
          ...
          >
            ...
            <div className="px-6 py-4 border-b border-white/5 bg-gradient-to-r from-[#5E54F2] to-[#7C3AED] rounded-t-2xl flex items-center justify-between">
              <h3 className="text-xl font-bold text-white">اضافة مستخدم</h3>
              <button
                onClick={cancelModal}
            ...
            {/* Modal Footer */}
            <div className="px-6 py-3 border-t border-white/5 flex items-center justify-start gap-3" dir="rtl">

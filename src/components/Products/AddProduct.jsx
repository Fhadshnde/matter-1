            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold mt-1 text-gray-900">{cardsData.totalProducts || '...'}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold mt-1 text-gray-900">{cardsData.lowInventoryProducts || '...'}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold mt-1 text-gray-900">{cardsData.outOfStockProducts || '...'}</p>
                    </div>
                    <span className="text-sm font-semibold text-red-500">↓ 2%</span>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold mt-1 text-gray-900">{cardsData.abandonedProducts || '...'}</p>
                    </div>
